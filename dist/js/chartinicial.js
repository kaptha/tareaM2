...
const Graph =new  Chart(document.getElementById("line-chart"), {
  type: "line",
  data: {
    ...
    datasets: [
      {
        ...
        data: await (RenderGraph('CAD')).map(i=>i),
       // label: "Peso",
      ...
      {
        data: cargarGrafico('EUR'),
        label: "Euro",
        borderColor: "#36a2eb",
        fill: false,
      },
      {
        data: cargarGrafico('USD'),
        label: "Dolar",
        borderColor: "#07b107",
        fill: false,
      },        
